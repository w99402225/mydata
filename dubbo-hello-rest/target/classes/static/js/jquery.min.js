/*! jQuery v1.11.1-rc2 | (c) 2005, 2014 jQuery Foundation, Inc. | jquery.org/license */ ! function(a, b) {
	...
	function ic(a, b, c) {
		...
		c.queue || (h = m._queueHooks(a, "fx"), null == h.unqueued && (h.unqueued = 0, i = h.empty.fire, h.empty.fire =
			...
			m.css(a, "display"), "inline" === ("none" === j ? Fb(a.nodeName) : j) && "none" === m.css(a, "float") && (k.inlineBlockNeedsLayout &&
				"inline" !== Fb(a.nodeName) ? o.zoom = 1 : o.display = "inline-block")), c.overflow && (o.overflow = "hidden", k.shrinkWrapBlocks() ||
			l.always(function() {
		...
		if (m.isEmptyObject(n)) "inline" === ("none" === j ? Fb(a.nodeName) : j) && (o.display = j);
			...
			q ? "hidden" in q && (p = q.hidden) : q = m._data(a, "fxshow", {}), f && (q.hidden = !p), p ? m(a).show() : l.done(
				function() {
					m(a).hide()
				}), l.done(function() {
				var b;
			...
			for (d in n) g = hc(p ? q[d] : 0, d, l), d in q || (q[d] = g.start, p && (g.end = g.start, g.start = "width" === d ||
				"height" === d ? 1 : 0))
		}
	}
